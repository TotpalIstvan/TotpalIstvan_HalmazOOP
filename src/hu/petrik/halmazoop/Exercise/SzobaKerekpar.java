...
public class SzobaKerekpar {
    ...
    public static void Run() {
        ...
        System.out.println(String.format("%d napon használták a biciklit", unio.getSize()));
        System.out.println(String.format("A szobakerékpárnak %.2f százalékos a kihasználtásága", unio.getSize()/31.0));
